...
IgnChassisCmdPublisher::IgnChassisCmdPublisher(const std::shared_ptr<ignition::transport::Node> &ign_node,
...
void IgnChassisCmdPublisher::publish(double v_x,double v_y,double v_w){
